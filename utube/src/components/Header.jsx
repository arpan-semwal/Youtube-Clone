  ...
  return (
    <div className='sticky top-0 z-10 flex flex-row items-center h-14 px-4 md:px-5 bg-white dark:bg-black justify-between'>
      ...
      <div className='flex items-center justify-center flex-grow'>
        ...
        <button
          className='w--[40px] md:w-[60px] h-8 md:h-10 flex items-center justify-center border border-l-0 border-[#303030] rounded-tr-4xl bg-white/[0.1]'
      ...
      <div className='flex items-center'>
        ...
        <div className='flex h-8 w-8 overflow-hidden rounded-full md:ml-4'>
          <img src='https://robohash.org/stefan-one' alt='Profile' />
        </div>
      </div>
    </div>
  );
