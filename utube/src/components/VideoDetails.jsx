...
const VideoDetails = () => {
  ...
  // Fetch video details for the video that we have clicked to play
    ...
    <div className='flex justify-center flex-row h-[calc(100%-56px)] bg-black'>
      <div className='w-full max-w-[1280px] flex flex-col lg:flex-row'>
              ...
              <div className='flex'>
                <div className="flex items-start">
                  <div className='flex h-11 w-11 rounded-full overflow-hidden'>
                    <img className='h-full w-full object-cover' src={video.author?.avatar[0]?.url} alt="Author Avatar" />
                  </div>
                </div>
        ...
        <div className='flex flex-col py-6 px-4 overflow-y-auto lg:w-[350px] xl:w-[400px]'>
          {relatedVideos?.contents && relatedVideos.contents.map((items, index) => {
